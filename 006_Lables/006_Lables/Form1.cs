...
namespace _006_Lables
{
    public partial class Form1: Form
    {
        ...
        private void btnRaffaello_Click(object sender, EventArgs e)
        {
            ...
            lblArtist.Text = "라파엘로 산치오 다 우르비노는 르네상스 시대 이탈리아의 예술가.";
        }

        private void btnD_Click(object sender, EventArgs e)
        {
            lblArt.Text = "레오나르도 다 빈치가 그린 초상화로, 현재 프랑스 파리 루브르 박물관에 전시되어 있다. \"모나\"(mona)는 유부녀 이름 앞에 붙이는 이탈리아어 경칭이고, \"리자\"(Lisa)는 초상화의 모델이 된 여인의 이름이다. 즉, 한국어로 하면 \"리자 여사\"라는 뜻이 된다. 이탈리아에서는 《조콘다》(이탈리아어: Gioconda)라 하는데 이는 \"조콘도의 부인\" 또는 \"명랑한 여자\", \"웃고 있는 여자\"라는 뜻이다.";
            lblArtist.Text = "《모나리자》는 16세기 르네상스 시대에 레오나르도 다 빈치가 그린 초상화";
        }
